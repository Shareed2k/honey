---
id: honey_recordings_replay
title: honey recordings replay
---

## honey recordings replay

Replay a session recording in the terminal

```
honey recordings replay &lt;basename&gt; [flags]
```
