---
id: honey_recordings_summarize
title: honey recordings summarize
---

## honey recordings summarize

Summarize a recording using an LLM (requires OPENAI_API_KEY)

```
honey recordings summarize &lt;basename&gt; [flags]
```
...
```
  -h, --help           help for summarize
      --model string   LLM model (default: OPENAI_MODEL env or gpt-4o-mini)
```
