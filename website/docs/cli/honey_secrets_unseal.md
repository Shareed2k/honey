---
id: honey_secrets_unseal
title: honey secrets unseal
---

## honey secrets unseal

Decrypt a secure:v1 ref to plaintext

### Synopsis

Reads a secure:v1:… ref from the argument, --file, or stdin and prints the decrypted
plaintext to stdout. Warning: plaintext may appear in shell history and logs.

```
honey secrets unseal [secure-ref] [flags]
```
