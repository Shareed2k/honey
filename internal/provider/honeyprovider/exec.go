...
// Upload is not supported for upstream Honey proxying yet.
func (c *Client) Upload(_, _ string) error {
	return fmt.Errorf("Upload is not supported for upstream Honey proxying yet")
}

// Download is not supported for upstream Honey proxying yet.
func (c *Client) Download(_, _ string) error {
	return fmt.Errorf("Download is not supported for upstream Honey proxying yet")
}
