...
func TestWritePrefixedLineFiltering(t *testing.T) {
	...
	// Match
	writePrefixedLine(context.Background(), &out, &mu, "P: ", "An error occurred", re, false, nil, false)
	// No match
	writePrefixedLine(context.Background(), &out, &mu, "P: ", "Just some info", re, false, nil, false)
...
func TestWritePrefixedLineAnomalyOnly(t *testing.T) {
	...
	writePrefixedLine(context.Background(), &out, &mu, "P: ", "all good", nil, false, d, true)
	writePrefixedLine(context.Background(), &out, &mu, "P: ", "panic in worker", nil, false, d, true)
